    ...
    <View style={tailwind`flex-1 bg-white`}>
      ...
      <View style={tailwind`flex-1 flex flex-col justify-end`}>
        <ScrollView style={tailwind`flex-1 px-2`}>
          ...
          <Text style={tailwind`text-2xl font-bold`}>Dine With Me Inc.</Text>
          ...
          <Text style={tailwind`text-base mt-2`}>Dine With Me was designed, debeloped, and release with one goal in mind. Bringing incredible and amamzing recipes to the world. from 
